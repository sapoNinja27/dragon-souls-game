...
//
//public abstract class Companion extends Entidade implements HudCommons {
...
//    }
//
//    public Companion(int x, int y, main.DadosGame dadosGame) {
//        super(x, y, 0, 0);
...
//
//    @Override
//    public void tick(main.DadosGame dadosGame) {
//        depth = 1;
//        verificarAcao();
...
//    }
//
//    public void desenharInfo(int x, int y, Graphics g, main.DadosGame dadosGame, Habilidade habilidade) {
//        x = x - 10;
//        String titulo = "Tai";
...
//
//    @Override
//    public void render(Graphics g, main.DadosGame dadosGame) {
...
//        }
//        drawPlayer(g, tileSize, x, y);
//        super.render(g, dadosGame);
//    }
//
//    private void drawPlayer(Graphics g, int tileSize, int x, int y) {
//        ImageUtils.applySombreamento(
//                g,
//                spriteAtual().get(index),
//                tileSize,
//                x,
//                y,
//                sombreamento,
...
//    }
//
//    public void updateCamera(main.DadosGame dadosGame) {
...
//
//
//    public void lifesistem(main.DadosGame dadosGame) {
//        if (vida <= 0) {
//            vida = 0;
//            dadosGame.gameOver();
//        }
...
//    }
//
//    public void setPlayer(Companion player) {
