//package main.entidades.inimigos.chefes;
//
...
//
//public class PupkinBoss extends Entidade {
//	public static int index;
//	int indexF;
////	public static boolean fuma�a;
//	int framesFumacinha;
...
//	public PupkinBoss(int x, int y, int width, int height) {
//		super(x, y, width, height, 14);
//
//	}
//	public void tick() {
////		frames++;
