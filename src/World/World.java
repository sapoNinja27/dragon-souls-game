...
public class World {
	...
	private Predio[] predios = { new Predio(0, 0, 0, 7, 4, Texturas.MARMORE),
			new Predio(1, 0, 0, 6, 4, Texturas.MARMORE), new Predio(2, 0, 0, 9, 4, Texturas.MARMORE),
			new Predio(3, 0, 0, 25, 4, Texturas.MARMORE), new Predio(4, 0, 0, 12, 4, Texturas.MARMORE),
			new Predio(5, 0, 0, 11, 4, Texturas.MARMORE), new Predio(6, 0, 0, 32, 4, Texturas.MARMORE),
			new Predio(7, 0, 0, 9, 4, Texturas.MARMORE), new Predio(8, 0, 0, 7, 4, Texturas.MARMORE),
			new Predio(9, 0, 0, 9, 4, Texturas.MARMORE) };
	private int cor = 0;
