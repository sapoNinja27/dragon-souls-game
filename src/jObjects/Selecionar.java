...
///**
// * Bot�o Select
// * @apiNote essa classe � uma copia do campo de texto sem funcionalidade ainda
// */
...
//	private int mx,my;
//	public Selecionar(int x, int y, int w, int h, int aw,int ah, String text, Color cor,int borda,int font) {
//		this.x=x;
//		this.y=y;
//		this.w=w;
//		this.h=h;
...
//	}
//
//	public Selecionar(int x, int y, int w, int h, String text, Color cor,int borda,int font) {
//		this.x=x;
//		this.y=y;
//		this.w=w;
//		this.h=h;
