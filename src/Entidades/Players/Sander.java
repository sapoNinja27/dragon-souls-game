...
public class Sander extends Player{
	...
	public Sander(int x, int y) {
		...
		//respirando
		for(int i =0; i < 4; i++){
			rightTai[i] =   Game.sander.getSprite(Configuracoes.TILE_SIZE*i, Configuracoes.TILE_SIZE*0, Configuracoes.TILE_SIZE, Configuracoes.TILE_SIZE);
		}
		//correndo
		for(int i =0; i < 9; i++){
			rightTai[i+4] =   Game.sander.getSprite(Configuracoes.TILE_SIZE*i, Configuracoes.TILE_SIZE*1, Configuracoes.TILE_SIZE, Configuracoes.TILE_SIZE);
		}
		//pulando
		for(int i =0; i < 6; i++){
			rightTai[i+13] =   Game.sander.getSprite(Configuracoes.TILE_SIZE*i, Configuracoes.TILE_SIZE*2, Configuracoes.TILE_SIZE, Configuracoes.TILE_SIZE);
		}
		//dash
		for(int i =0; i < 5; i++){
			rightTai[i+19] =   Game.sander.getSprite(Configuracoes.TILE_SIZE*i, Configuracoes.TILE_SIZE*3, Configuracoes.TILE_SIZE, Configuracoes.TILE_SIZE);
		}
//		//parado soco
		for(int i =0; i < 4; i++){
			rightTai[i+24] =   Game.sander.getSprite(Configuracoes.TILE_SIZE*i, Configuracoes.TILE_SIZE*4, Configuracoes.TILE_SIZE, Configuracoes.TILE_SIZE);
		}
//		//socos
		for(int i =0; i < 6; i++){
			rightTai[i+28] =   Game.sander.getSprite(Configuracoes.TILE_SIZE*i, Configuracoes.TILE_SIZE*5, Configuracoes.TILE_SIZE, Configuracoes.TILE_SIZE);
		}
//		//hb1
		for(int i =0; i < 9; i++){
			rightTai[i+34] =   Game.sander.getSprite(Configuracoes.TILE_SIZE*i, Configuracoes.TILE_SIZE*6, Configuracoes.TILE_SIZE, Configuracoes.TILE_SIZE);
		}
//		//h2
//		for(int i =0; i < 4; i++){
